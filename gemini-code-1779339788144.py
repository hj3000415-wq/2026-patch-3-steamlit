...
def get_shared_canvas():
    # 10x10 크기의 흰색('#FFFFFF') 도화지 생성
    return np.full((10, 10), "#FFFFFF", dtype=object)
...
row_input = st.sidebar.number_input("행 (Y축 좌표: 0~9)", min_value=0, max_value=9, value=5)
col_input = st.sidebar.number_input("열 (X축 좌표: 0~9)", min_value=0, max_value=9, value=5)
